...
<head>
    ...
    <title>BookStore+ - Your One-Stop Shop for Books and Supplies</title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex">
                    <?php if(isset($_SESSION['user_id'])): ?>
                        <span class="text-white me-3 mt-2">Welcome, <?php echo htmlspecialchars($_SESSION['username']); ?></span>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Welcome to BookStore+</h1>
                <p class="lead fw-normal text-white-50 mb-0">Your One-Stop Shop for Books and School Supplies</p>
            </div>
        </div>
    </header>
